	...
	<body ondblclick="fullScreen()">
		...
		/**===============================websocket======================================**/
			...
			function openChannel() {
				...
				socket = new WebSocket("ws://192.168.1.118:8080/WebRTC/manyrtcwebsoketdemo.video/clientA");
...
/**=======================webrtc peerconnection 1111111111111111 start==================*/
			...
			function processSignalingMessage(message) {
				...
				if (msg.type == "offer") {
					if(msg.userid == "clientB") {
						pc.setRemoteDescription(new RTCSessionDescription(msg));
						doAnswer();
					} else if(msg.userid == "clientC"){
