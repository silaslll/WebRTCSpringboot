...
import sun.misc.BASE64Encoder;
    ...
    public class Duqu {
        ...
        public static void main(String[] args) throws Exception {
            // 发送POST请求示例
            String ak_id = "LTAIcfGIkjj3kI67"; //用户ak
            String ak_secret = "PBhEwyfV6b1qaPNtiBlhVK3yALFhqd"; // 用户ak_secret
            String url = "https://dtplus-cn-shanghai.data.aliyuncs.com/face/verify";
            String body = "{\r\n" + 
              		"\"type\":0,\r\n" + 
              		"\"image_url_1\":\"localhost:8092/1556092024.jpg\",\r\n" + 
              		"\"image_url_2\":\"localhost:8092/1556098110.jpg\"\r\n" + 
              		"}";
            System.out.println("response body:" + sendPost(url, body, ak_id, ak_secret));
        }
        
        public String send(String img_url1,String img_url2) {
        	  String ak_id = "LTAIcfGIkjj3kI67"; //用户ak
              String ak_secret = "PBhEwyfV6b1qaPNtiBlhVK3yALFhqd"; // 用户ak_secret
              String url = "https://dtplus-cn-shanghai.data.aliyuncs.com/face/verify";
              String body = "{\r\n" + 
              		"\"type\":0,\r\n" + 
              		"\"image_url_1\":"+img_url1+",\r\n" + 
              		"\"image_url_2\":"+img_url2+"\r\n" + 
              		"}";
              
              String map = "";
              try {
				 map = sendPost(url, body, ak_id, ak_secret);
			} catch (Exception e) {
